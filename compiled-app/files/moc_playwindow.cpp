...
#include "../../DesktopClient_qt6/playwindow.h"
...
static constexpr auto qt_meta_stringdata_CLASSPlayWindowENDCLASS = QtMocHelpers::stringData(
    "PlayWindow"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSPlayWindowENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSPlayWindowENDCLASS_t qt_meta_stringdata_CLASSPlayWindowENDCLASS = {
    {
